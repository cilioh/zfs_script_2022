...
do
	...
	ssh cn8 'sh /mnt/share/cykim/backup/load_stress_gc.sh 256MB 16 CN8 banana '${stripe} &
	ssh cn9 'sh /mnt/share/cykim/backup/load_stress_gc.sh 1G 16 CN9 citrus '${stripe} &
	ssh cn10 'sh /mnt/share/cykim/backup/load_stress_gc.sh 4G 16 CN10 dragonfruit '${stripe} &
