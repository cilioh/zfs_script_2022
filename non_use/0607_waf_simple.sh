...
mkdir /mnt/share/cykim/result/${folder}
...
ssh pm1 'sh /mnt/share/cykim/backup/waf_monitor_pm1_intel.sh 1' &
ssh pm2 'sh /mnt/share/cykim/backup/waf_monitor_pm_intel.sh 2' &
ssh pm3 'sh /mnt/share/cykim/backup/waf_monitor_pm_intel.sh 3' &
...
#	do
	...
	fio --directory=/mnt/lustre --name=preset --rw=write --direct=0 --bs=1M --size=3144399200KB --numjobs=1 --group_reporting --fallocate=none
	sleep 10
...
#	sh /mnt/share/cykim/backup/load_stress_gc.sh 4G 16 CN10 dragonfruit ${stripe} &
	sh /mnt/share/cykim/backup/load_stress_gc_WAF.sh 32GB 16 CN7 apple ${stripe} &
